...
public:
  ...
  // Setters
  void set_hit_layers(vector<bool> setter_layers);
  void set_inner_pixel_layer(bool setter_inner);
  void set_outer_pixel_layer(bool setter_outer);
  void set_strip_layer(bool setter_strip);
