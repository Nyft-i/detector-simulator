...
string Detector::guess_particle()
{
  ...
  {possible_particles.remove_if([](string const & x) {return x != "muon/antimuon";}); return possible_particles.front();} // Return early as it can only be a muon
